...
def checarEscritorios(grupos):
    ...
    gruposArrayFormatted = gruposArray[0].replace("\\n", "")
    gruposArrayFormatted = [gruposArrayFormatted]
    return gruposArrayFormatted[0]
    instituicoes = gruposArrayFormatted[0].split(': ')[0]
    categorias = ': '.join(gruposArrayFormatted[0].split(': ')[1:])
...
print(checarEscritorios("WHO´S WHO BRAZIL: Cleber1\\n"))
# else:
